...
Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de dfdbb dgfeger wefgdbdv para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:
<ul className='cookies-ul'>
    <li className='cookies-li'>Permitir la identificación anónima de los usuarios navegantes a través de la cookie (identifica navegadores y dispositivos, no personas) y por lo tanto la contabilización aproximada del número de visitantes y su tendencia en el tiempo.</li>
    <li className='cookies-li'>Identificar de forma anónima los contenidos más visitados y por lo tanto más atractivos para los usuarios Saber si el usuario que está accediendo es nuevo o repite visita.</li>
</ul>

Importante: Salvo que el usuario decida registrarse en un servicio de dfdbb dgfeger wefgdbdv, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.

<h3>Cookies de publicidad</h3>

Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de dfdbb dgfeger wefgdbdv. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.

<h3>Cookies publicitarias de terceros</h3>

Además de la publicidad gestionada por las webs de dfdbb dgfeger wefgdbdv en sus servicios, las webs de dfdbb dgfeger wefgdbdv ofrecen a sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros pueden almacenar cookies enviadas desde los servicios de dfdbb dgfeger wefgdbdv procedentes de los navegadores de los usuarios, así como acceder a los datos que en ellas se guardan.
...
<ul className='cookies-ul'>
    <li className='cookies-li'>Para más información sobre la administración de las cookies en Google: <a className='cookie-link' href="https://support.google.com/chrome/answer/95647?hl=es">https://support.google.com/chrome/answer/95647?hl=es</a> </li>
    <li className='cookies-li'>Para más información sobre la administración de las cookies en Internet Explorer: <a className='cookie-link' href="http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-questions">http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-questions</a> </li>
    <li className='cookies-li'>Para más información sobre la administración de las cookies en Mozilla Firefox: <a className='cookie-link' href="http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we">http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we</a></li>
    <li className='cookies-li'>Para más información sobre la administración de las cookies en Safari: <a className='cookie-link' href="http://www.apple.com/es/privacy/use-of-cookies/">http://www.apple.com/es/privacy/use-of-cookies/</a></li>
    <li className='cookies-li'>Para más información sobre la administración de las cookies en Opera: <a className='cookie-link' href="http://help.opera.com/Windows/11.50/es-ES/cookies.html">http://help.opera.com/Windows/11.50/es-ES/cookies.html</a></li>
</ul>

Si desea dejar de ser seguido por Google Analytics visite: <a className='cookie-link' href="http://tools.google.com/dlpage/gaoptout">http://tools.google.com/dlpage/gaoptout</a>

<h3>Para saber más sobre las cookies</h3>

Puede obtener más información sobre la publicidad online basada en el comportamiento y la privacidad online en el siguiente enlace: <a className='cookie-link' href="http://www.youronlinechoices.com/es/">http://www.youronlinechoices.com/es/</a>
<ul className='cookies-ul'>
    <li className='cookies-li'>Protección de datos de Google Analytics: <a className='cookie-link' href="http://www.google.com/analytics/learn/privacy.html">http://www.google.com/analytics/learn/privacy.html</a></li>
    <li className='cookies-li'>Cómo usa Google Analytics las cookies: <a className='cookie-link' href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=es#analyticsjs">https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=es#analyticsjs</a>
</li>
</ul>
...
Las webs de Clínica Raulfisio pueden modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.
