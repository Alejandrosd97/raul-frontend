...
const textoAleman = [
    ...
    {clinicas:[{
        ...
        clinicaGandiaComoLlegar : 'Lokalisierung',
    ...
    {titulos: {
        nuestrasClinicas :'Unsere praxis',
        tratamientos : 'Behandlungen',
        sobreNosotros : 'Über uns',
        contactanos : 'Schreiben uns',
        localizacion : 'Localisierung'
    ...
    {tratamientos : [
       ...
       descripcion : `Akupunktur ist eine Therapie, die auf der traditionellen chinesischen Medizin basiert, bei der feine Nadeln an bestimmten Stellen des Körpers eingeführt werden, um die Lebensenergie (Qi) zu stimulieren und die Selbstheilung zu fördern. Es wird verwendet, um eine Vielzahl von Bedingungen wie chronische Schmerzen, Stress, Angst, Schlafstörungen und Muskel-Skelett-Erkrankungen zu behandeln. Akupunktur kann helfen, Schmerzen zu lindern und das allgemeine Wohlbefinden zu verbessern`} ,
        ...
        {titulo:'Therapeutische Bewegung',
        descripcion : 'Therapeutische Bewegung ist ein wesentlicher Bestandteil der Physiotherapie, entwickelt, um Kraft, Beweglichkeit, Beweglichkeit und Körperfunktion zu verbessern. Diese Art von Übung ist auf die individuellen Bedürfnisse des Patienten zugeschnitten und konzentriert sich auf bestimmte Bereiche, die von Verletzungen oder Erkrankungen betroffen sind. Unter der Aufsicht von medizinischem Fachpersonal hilft die therapeutische Bewegung, Schmerzen zu lindern, die Körperhaltung zu verbessern und die Lebensqualität der Patienten wiederherzustellen, was erheblich zu ihrer Genesung und ihrem Wohlbefinden beiträgt.'}
    ]
    },
    {
    contacto :{
        titulo :'Kontaktieren Sie uns',
        parrafo : 'Erklären Sie uns den Grund für Ihre Anfrage und wir werden uns so schnell wie möglich bei Ihnen melden.',
        nombre : 'Name',
        email :'Email',
        asunto: 'Angelegenheit',
        consulta: 'Abfrage',
        enviar : 'Schicken ',
        politica : 'Ich habe die Datenschutzerklärung gelesen und akzeptiere sie. ',
        enlace : 'Mehr lesen'
    }
    },
    {
    ...
    hero : {
        ...
        main : 'Ihr Weg zu Gesundheit und Wohlbefinden',
        consultarTratamientos : 'Unsere Behandlungen'
    }
    },
    {
        colaboraciones: {
            titulo : 'in Zusammenarbeit mit',
